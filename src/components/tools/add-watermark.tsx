...
export default function AddWatermark() {
    ...
    const handleApplyWatermark = async () => {
        ...
        if (!watermarkText.trim()) {
            toast({ variant: 'destructive', title: 'No Watermark Text', description: 'Please enter text for the watermark.' });
            return;
        }

        setIsProcessing(true);
        toast({ title: 'Adding watermark to your PDF...' });
    ...
    return (
        <Card className="w-full shadow-lg rounded-lg bg-card/60 backdrop-blur-lg">
            <CardHeader>
                ...
                <CardDescription>Stamp a text watermark onto every page of your PDF. Secure, private, and fast.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <Button onClick={handleApplyWatermark} disabled={!file || !watermarkText.trim() || isProcessing} className="w-full">
                    {isProcessing ? (
