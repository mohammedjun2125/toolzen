...
const categoryInfo: { [key: string]: Omit<ToolCategoryInfo, 'id'> } = {
  'image-media': { name: 'Image & Media', description_short: 'Compress, resize, and edit images and other media formats.', icon: ImageIcon },
  'pdf': { name: 'PDF Tools', description_short: 'Create, merge, split, and edit PDF documents securely in your browser.', icon: FileText },
  'text-data': { name: 'Text & Data', description_short: 'Format, convert, and analyze text and data for any project.', icon: NotepadText },
...
export const tools: Tool[] = [
  ...
  { id: 'gif-maker', name: 'GIF Maker', description: 'Create animated GIFs from a sequence of images.', href: '/tools/gif-maker', icon: FileCog, category: categoryMap.get('image-media')! },
  ...
  { id: 'calendar', name: 'Calendar', description: 'A simple and clean monthly calendar view.', href: '/tools/calendar', icon: Calendar, category: categoryMap.get('utilities')! },
