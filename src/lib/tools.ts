...
const categoryInfo: { [key: string]: Omit<ToolCategoryInfo, 'id'> } = {
  'image-media': { name: 'Image & Media Tools', description_short: 'Compress, resize, convert, and edit images and other media formats.', icon: 'image' },
  'pdf': { name: 'PDF Tools', description_short: 'Create, merge, split, and edit PDF documents securely in your browser.', icon: 'file-text' },
  'text-data': { name: 'Text & Data Tools', description_short: 'Format, convert, and analyze text and data for any project.', icon: 'notepad-text' },
  ...
  'utilities': { name: 'Web Utilities', description_short: 'Handy developer utilities for DNS, IP, and SSL lookups.', icon: 'utility-pole' },
};
...
export const tools: Tool[] = [
  ...
  { id: 'pdf-deleter', name: 'Delete PDF Pages', description: 'Remove one or more pages from a PDF document.', href: '/tools/pdf-deleter', icon: 'trash-2', category: categoryMap.get('pdf')! },
  { id: 'add-watermark', name: 'Watermark PDF', description: 'Add a text watermark to your PDF files.', href: '/tools/add-watermark', icon: 'square-pen', category: categoryMap.get('pdf')! },
  { id: 'pdf-rotator', name: 'Rotate PDF', description: 'Rotate pages in a PDF document individually.', href: '/tools/pdf-rotator', icon: 'rotate-cw', category: categoryMap.get('pdf')! },
  { id: 'pdf-compressor', name: 'PDF Compressor', description: 'Reduce the file size of your PDF documents.', href: '/tools/pdf-compressor', icon: 'image-icon', category: categoryMap.get('pdf')! },
  { id: 'pdf-to-word-converter', name: 'PDF to Word', description: 'Convert PDF files to editable Word documents.', href: '/tools/pdf-to-word-converter', icon: 'file-key-2', category: categoryMap.get('pdf')! },
  { id: 'pdf-to-text', name: 'PDF to Text Extractor', description: 'Extract all text content from a PDF file.', href: '/tools/pdf-to-text', icon: 'file-cog', category: categoryMap.get('pdf')! },
  ...
  { id: 'case-converter', name: 'Case Converter', description: 'Convert text to various case formats.', href: '/tools/case-converter', icon: 'case-sensitive', category: categoryMap.get('text-data')! },
  ...
  { id: 'url-encoder-decoder', name: 'URL Encoder/Decoder', description: 'Encode or decode strings for URL-safe usage.', href: '/tools/url-encoder-decoder', icon: 'link-icon', category: categoryMap.get('text-data')! },
  ...
  { id: 'markdown-preview', name: 'Markdown Preview', description: 'Write and preview Markdown in a live editor.', href: '/tools/markdown-preview', icon: 'file-code', category: categoryMap.get('text-data')! },
  ...
  { id: 'text-reverser', name: 'Text Reverser', description: 'Reverse any text string instantly.', href: '/tools/text-reverser', icon: 'rotate-cw', category: categoryMap.get('text-data')! },
  ...
  { id: 'qr-code-generator', name: 'QR Code Generator', description: 'Generate QR codes from text, URLs, or contact info.', href: '/tools/qr-code-generator', icon: 'qr-code', category: categoryMap.get('generators')! },
  { id: 'lorem-ipsum-generator', name: 'Lorem Ipsum Generator', description: 'Generate placeholder dummy text for your designs.', href: '/tools/lorem-ipsum-generator', icon: 'book-type', category: categoryMap.get('generators')! },
  ...
  { id: 'ip-lookup', name: 'IP Address Locator', description: 'Find IP address location and other geolocation details instantly.', href: '/tools/ip-lookup', icon: 'mouse-pointer', category: categoryMap.get('utilities')! },
